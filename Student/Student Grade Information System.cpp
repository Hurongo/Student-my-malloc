...

{
  ...
  void journal()
  {
      ...
      ptr = (student*)malloc(32 * sizeof(student));
      if (ptr == NULL) {
      ...
      cin.ignore();
      cin.get();
      cout << "\t\t\t\t1. PROGRAMMING MARK JOURNAL\n\n";
      cout << "\t\t\t\t2. ARCITECTURE MARK JOURNAL\n\n";
      cout << "\t\t\t\t3. WRITING SKILL MARK JOURNAL\n\n";
      cout << "\t\t\t\t4. ALGEBRA MARK JOURNAL\n\n";
      cin >> cc;
      cout << endl;
      switch (cc)
      {
      case '1':
      {
          ...
          {
              ptr[j] = s;
              cout << "\t\t\t\t|STUDENT NAME :" << s.name  << "|STUDENT ID NUMBER : " << s.id << "|PROGRAMMING MARK :" << s.pro << endl;
              check = true;
          }
          break;
      }
      case '2':
      {
          ...
          {
              ptr[j] = s;
              cout << "\t\t\t\t|STUDENT NAME :" << s.name << "|STUDENT ID NUMBER : " << s.id << "|ARCITECTURE MARK :" << s.arc << endl;
              check = true;
          }
          break;
      }
      case '3':
      {
          ...
          {
              ptr[j] = s;
              cout << "\t\t\t\t|STUDENT NAME :" << s.name << "|STUDENT ID NUMBER : " << s.id << "|WRITING SKILL MARK :" << s.writing << endl;
              check = true;
          }
          break;
      }
      case '4':
      {
          ...
          {
              ptr[j] = s;
              cout << "\t\t\t\t|STUDENT NAME :" << s.name << "|STUDENT ID NUMBER : " << s.id << "|ALGEBRA MARK :" << s.alg << endl;
              check = true;
          }
          break;
      }
